...
export function DynamicIsland() {
  ...
  return (
    <>
      <nav
        className={`fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around px-4 py-3 bg-[var(--color-bg)] border-t border-white/10 transition-opacity duration-400 lg:hidden ${
