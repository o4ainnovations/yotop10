...
export function SlideMenu() {
  ...
  return (
    <>
      ...
      {/* Slide-out panel */}
      <div
        className={`fixed top-0 right-0 z-[70] h-full w-80 bg-[#05050f] border-l border-white/5 shadow-2xl transform transition-transform duration-300 ease-out flex flex-col ${
