    ...
    <>
      ...
      <div className="hidden lg:block pb-24">
        {posts.length === 0 ? (
          ...
          <div className="flex flex-row overflow-x-auto overflow-y-hidden gap-3 pl-8 pr-8 py-6 -webkit-overflow-scrolling-touch snap-x snap-mandatory scroll-smooth">
            {posts.map((post) => (
